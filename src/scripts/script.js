...
const apiKey = "6b64b5d827f5afe9bb347cd356f29646"; 
...
function setBackground(weather) {
    ...
    let bgImage = "D:\Weather-Dashboard\images\._sunny.jpg"; 

    weather = weather.toLowerCase();
    if (weather.includes("cloud")) bgImage = "D:\Weather-Dashboard\images\cloudy.jpg";
    else if (weather.includes("rain") || weather.includes("drizzle")) bgImage = "D:\Weather-Dashboard\images\rainy.jpg";
    else if (weather.includes("snow")) bgImage = "D:\Weather-Dashboard\images\snow.jpg";
    else if (weather.includes("fog") || weather.includes("mist")| weather.includes("haze")) bgImage = "D:\Weather-Dashboard\images\fog.jpg";
